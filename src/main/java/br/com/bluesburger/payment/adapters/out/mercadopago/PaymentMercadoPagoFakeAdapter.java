...
public class PaymentMercadoPagoFakeAdapter implements PaymentMercadoPagoPort {
    ...
    public PaymentResponseMP generatePaymentQRCode(Payment payment) {
        return new PaymentResponseMP("1", "qwerty", "2024-08-01T00:37:54", "PAID", "Paid", payment.getOrderId(), QR_CODE);
    }
    ...
    public Payment getPayment(String paymentId) {
    	...
    	return new Payment(paymentId, "qwerty", "qwerty", "PAID", "2024-08-01T00:37:54", "qwerty", "PAID", "method", "2024-08-01T00:40:15", null, 
